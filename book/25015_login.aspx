<%@ Page Language="C#" AutoEventWireup="true" CodeFile="25015_login.aspx.cs" Inherits="_25015_login" %>
        ...
        <header id="home">
            <div class="container">
                <div class="header d-lg-flex justify-content-between align-items-center py-sm-3 py-2 px-sm-2 px-1">
                    ...
                    <!-- //logo -->
                    <!-- nav -->
                    <div class="nav_w3ls ml-lg-5" visible="False">
                        <nav>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb d-flex justify-content-center">
                <li class="breadcrumb-item">
                    <a href="25015_index.aspx">Home</a>
                </li>
        ...
        <div class="modal-body align-w3">
            <form action="#" method="post" class="p-sm-3">
                <div class="form-group">
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter your email" required="" TextMode="Email" ToolTip="Enter registered email"></asp:TextBox>
                </div>
                <div class="form-group">
                    <label for="password" class="col-form-label">Password</label>
                    <asp:TextBox ID="TextBox2" runat="server" class="form-control" placeholder="Enter your password" required="" TextMode="Password" ToolTip="Enter Registered password"></asp:TextBox>
                </div>
                <div class="right-w3l">
                    <asp:Button ID="Button1" runat="server" Text="Login" class="form-control bg-theme" OnClick="Button1_Click" />
                </div>
				...
				<a href="25015_register.aspx" class="text-theme-2 font-weight-bold">Register Now</a>
                </p>
            </form>
        </div>
        <!-- //login -->
